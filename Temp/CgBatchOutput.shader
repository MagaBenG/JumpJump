...
//   opengl - ALU: 18 to 69
//   d3d9 - ALU: 18 to 69
//   d3d11 - ALU: 17 to 55, TEX: 0 to 0, FLOW: 1 to 1
//   d3d11_9x - ALU: 17 to 55, TEX: 0 to 0, FLOW: 1 to 1
SubProgram "opengl " {
...
void main ()
{
  ...
  c_1.xyz = (c_1.xyz + ((textureCube (_Cube, tmpvar_2) * tmpvar_3.w).xyz * _ReflectColor.xyz));
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_4.xyz * ((8.0 * tmpvar_6.w) * tmpvar_6.xyz));
  c_1.w = tmpvar_5;
  c_1.xyz = (c_1.xyz + ((textureCube (_Cube, tmpvar_2) * tmpvar_3.w).xyz * _ReflectColor.xyz));
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
...
Program "fp" {
// Fragment combos: 3
//   opengl - ALU: 10 to 12, TEX: 2 to 3
//   d3d9 - ALU: 8 to 11, TEX: 2 to 3
//   d3d11 - ALU: 6 to 9, TEX: 2 to 3, FLOW: 1 to 1
//   d3d11_9x - ALU: 6 to 9, TEX: 2 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" }
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedmbpmnnijcoicnlkgmkieogpeiabfjnniabaaaaaaciadaaaaadaaaaaa
...
fdeieefccaacaaaaeaaaaaaaiiaaaaaafjaaaaaeegiocaaaaaaaaaaaafaaaaaa
...

...
adaaaaaaacaaapacaaaaaaoeacaaaaaaacaaaaoeabaaaaaa mul r2, r0, c2
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedoalafbidfopjkoeplldnicbhhemkjnejabaaaaaalaaeaaaaaeaaaaaa
...

...

...
abaaaaaaegiccaaaaaaaaaaaaeaaaaaaegacbaaaaaaaaaaadoaaaaabejfdeheo
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecediinhnlhkcmjckgfogipceeoeehohbpdoabaaaaaanaacaaaaadaaaaaa
...
egaobaaaacaaaaaaegiocaaaaaaaaaaaadaaaaaadiaaaaaihcaabaaaabaaaaaa
egacbaaaabaaaaaaegiccaaaaaaaaaaaaeaaaaaadcaaaaajhccabaaaaaaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedmoebcgfjgipmmlffobhligbmjehfldckabaaaaaacaaeaaaaaeaaaaaa
daaaaaaahmabaaaageadaaaaomadaaaaebgpgodjeeabaaaaeeabaaaaaaacpppp
...

...
pgapbaaaacaaaaaadiaaaaaipcaabaaaacaaaaaaegaobaaaacaaaaaaegiocaaa
aaaaaaaaadaaaaaadiaaaaaihcaabaaaabaaaaaaegacbaaaabaaaaaaegiccaaa
aaaaaaaaaeaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaaacaaaaaaegacbaaa
